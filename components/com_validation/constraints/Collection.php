 ...
 * @api
 */
class ComValidationConstraintCollection extends ComValidationConstraintDefault
{
    public $fields;
    public $allowExtraFields = false;
    public $allowMissingFields = false;
    public $extraFieldsMessage = 'The field {{ field}} was not expected.';
    public $missingFieldsMessage = 'The field {{ field}} is missing.';
